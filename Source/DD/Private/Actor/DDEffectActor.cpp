...
#include "Actor/DDEffectActor.h"
#include "AbilitySystemBlueprintLibrary.h"
#include "AbilitySystemComponent.h"

// Sets default values
ADDEffectActor::ADDEffectActor()
{
...
void ADDEffectActor::BeginPlay()
{
	Super::BeginPlay();
}

void ADDEffectActor::ApplyEffectToTarget(AActor* TargetActor, TSubclassOf<UGameplayEffect> GameplayEffectClass)
{
...
void ADDEffectActor::OnOverlap(AActor* TargetActor)
{
...
void ADDEffectActor::OnEndOverlap(AActor* TargetActor)
{
